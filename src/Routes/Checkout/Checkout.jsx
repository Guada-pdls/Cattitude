      ...
      {typeof items === "undefined" ? (
        ...
        <>
          <form action="" onSubmit={(e) => submitHandler(e)}>
            ...
            <input name="cardNum" type="number" placeholder="Card number" />
            <div className="input-together">
              <input
                name="expiration"
                type="number"
            ...
            <h5>Where do you want to receive it?</h5>
          ...
          <aside>
            <h4 className="checkout-title">Purchase summary</h4>
            <ul>
              {!item
                ? // Carrito
                  cart.map((prod) => {
